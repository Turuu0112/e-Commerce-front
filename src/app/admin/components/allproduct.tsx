...
import { useData } from '@/app/utils/dataprovider'
                    ...
                    <Select>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                {categories.map((category: { _id: string; name: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined }, index: React.Key | null | undefined) => <SelectItem key={index} value={category._id}>{category.name}</SelectItem>)}
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                    <Select>
